...
function t(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),n.push.apply(n,r)}return n}function e(e){for(var r=1;r<arguments.length;r++){var c=null!=arguments[r]?arguments[r]:{};r%2?t(Object(c),!0).forEach(function(t){n(e,t,c[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(c)):t(Object(c)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(c,t))})}return e}function n(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function r(t,e,n,r,c,o,a){try{var i=t[o](a),u=i.value}catch(s){return void n(s)}i.done?e(u):Promise.resolve(u).then(r,c)}function c(t){return function(){var e=this,n=arguments;return new Promise(function(c,o){var a=t.apply(e,n);function i(t){r(a,c,o,i,u,"next",t)}function u(t){r(a,c,o,i,u,"throw",t)}i(void 0)})}}var o=require("axios");module.exports=function(t,n){var r=this,a=o.create(),i=t,u=n||null;a.defaults.withCredentials=!0,a.defaults.headers.common={Accept:"application/json;odata=verbose","Access-Control-Allow-Origin":"*","Access-Control-Allow-Headers":"Content-Type","Content-Type":"application/json;odata=verbose"},Object.defineProperty(r,"siteUrl",{get:function(){return i},set:function(t){i=t}}),Object.defineProperty(r,"listName",{get:function(){return u},set:function(t){u=t}}),Object.defineProperty(r,"baseUrl",{get:function(){return"".concat(i,"/_vti_bin/listdata.svc/").concat(u)}}),Object.defineProperty(r,"baseAttachmentUrl",{get:function(){return"".concat(i,"/_api/web/lists/getbytitle(").concat(u,")")}});var s=function(t){var e;t.Id=t.Id||t.Id0,t.Account=t.LoginName||t.AccountName||t.Account,t.AccountName=(e=t.Account,String(e).replace(/(.*)[\|](.*)/,"$2").replace(/\\/,"_")),t.UserId=t.AccountName.replace(/(.*)[_](.*)/,"$2"),t.Name=t.Name||t.DisplayName,t.PersonalUrl="https://mysite.na.xom.com/personal//".concat(t.AccountName),t.PictureUrl="http://lyncpictures/service/api/image/".concat(t.AccountName)};r.getUserInfo=function(){var t=c(regeneratorRuntime.mark(function t(n){var r,c,o,u,f,l;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if(!n){t.next=8;break}return t.next=3,a.get("".concat(i,"/_vti_bin/listdata.svc/UserInformationList?$top=1"));case 3:return r=t.sent,c=r.data.d.results[0].Id?"Id":"Id0",o=a.get("".concat(i,"/_api/Web/GetUserById(").concat(n,")")),u=a.get("".concat(i,"/_vti_bin/listdata.svc/UserInformationList?$filter=(").concat(c," eq ").concat(n,")")),t.abrupt("return",new Promise(function(t,n){Promise.all([o,u]).then(function(n){var r=e({},n[0].data.d,{},n[1].data.d.results[0]);s(r),t(r)}).catch(function(t){return n(t)})}));case 8:return f=a.get("".concat(i,"/_api/web/CurrentUser")),l=a.get("".concat(i,"/_api/SP.UserProfiles.PeopleManager/GetMyProperties")),t.abrupt("return",new Promise(function(t,n){Promise.all([f,l]).then(function(n){var r=e({},n[0].data.d,{},n[1].data.d);s(r),t(r)}).catch(function(t){return n(t)})}));case 11:case"end":return t.stop()}},t)}));return function(e){return t.apply(this,arguments)}}(),r.searchUser=function(t){return new Promise(function(e,n){a.get("".concat(i,"/_vti_bin/listdata.svc/UserInformationList?$filter=substringof('").concat(t,"',Name)")).then(function(t){return e(t.data.d.results)}).catch(function(t){return n(t)})})},r.get=function(t){return new Promise(function(e,n){a.get(r.baseUrl+(t||"")).then(function(t){return e(t.data.d.results)}).catch(function(t){return n(t)})})},r.getOne=function(t,e){return new Promise(function(n,c){a.get("".concat(r.baseUrl,"(").concat(t,")").concat(e||"")).then(function(t){return n(t.data.d.results)}).catch(function(t){return c(t)})})},r.post=function(t){return new Promise(function(e,n){a.post(r.baseUrl,t).then(function(t){return e(t.data.d.results)}).catch(function(t){return n(t)})})},r.put=function(t,n){return a.post("".concat(r.baseUrl,"(").concat(t,")"),n,{headers:e({},a.defaults.headers.common,{"X-Http-Method":"MERGE","If-Match":"*"})})},r.put=function(t,e){return r.merge(t,e)},r.delete=function(t){return a.post("".concat(r.baseUrl,"(").concat(t,")"),{},{headers:e({},a.defaults.headers.common,{"X-Http-Method":"DELETE","If-Match":"*"})})}};

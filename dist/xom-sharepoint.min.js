...
function t(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),n.push.apply(n,r)}return n}function e(e){for(var r=1;r<arguments.length;r++){var c=null!=arguments[r]?arguments[r]:{};r%2?t(Object(c),!0).forEach(function(t){n(e,t,c[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(c)):t(Object(c)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(c,t))})}return e}function n(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var r=require("axios");module.exports=function(t,n){var c=this,o=r.create(),a=t,i=n||null;o.defaults.withCredentials=!0,o.defaults.headers.common={Accept:"application/json;odata=verbose","Access-Control-Allow-Origin":"*","Access-Control-Allow-Headers":"Content-Type","Content-Type":"application/json;odata=verbose"},Object.defineProperty(c,"siteUrl",{get:function(){return a},set:function(t){a=t}}),Object.defineProperty(c,"listName",{get:function(){return i},set:function(t){i=t}}),Object.defineProperty(c,"baseUrl",{get:function(){return"".concat(a,"/_vti_bin/listdata.svc/").concat(i)}}),Object.defineProperty(c,"baseAttachmentUrl",{get:function(){return"".concat(a,"/_api/web/lists/getbytitle(").concat(i,")")}});var u=function(t){var e;t.Id=t.Id||t.Id0,t.Account=t.LoginName||t.AccountName||t.Account,t.AccountName=(e=t.Account,String(e).replace(/(.*)[\|](.*)/,"$2").replace(/\\/,"_")),t.User.Id=t.AccountName.replace(/(.*)[_](.*)/,"$2"),t.Name=t.Name||t.DisplayName,t.PersonalUrl="https://mysite.na.xom.com/personal//".concat(t.AccountName),t.PictureUrl="http://lyncpictures/service/api/image/".concat(t.AccountName)};c.getUserInfo=function(t){if(t){var n=o.get("".concat(a,"/_api/Web/GetUserById(").concat(t,")")),r=o.get("".concat(a,"/_vti_bin/listdata.svc/UserInformationList?$filter=(Id0 eq ").concat(t,")"));return new Promise(function(t,c){Promise.all([n,r]).then(function(n){var r=e({},n[0].data.d,{},n[1].data.d.results[0]);u(r),t(r)}).catch(function(t){return c(t)})})}var c=o.get("".concat(a,"/_api/web/CurrentUser")),i=o.get("".concat(a,"/_api/SP.UserProfiles.PeopleManager/GetMyProperties"));return new Promise(function(t,n){Promise.all([c,i]).then(function(n){var r=e({},n[0].data.d,{},n[1].data.d.results[0]);u(r),t(r)}).catch(function(t){return n(t)})})},c.searchUser=function(t){return new Promise(function(e,n){o.get("".concat(a,"/_vti_bin/listdata.svc/UserInformationList?$filter=substringof('").concat(t,"',Name)")).then(function(t){return e(t.data.d.results)}).catch(function(t){return n(t)})})},c.get=function(t){return new Promise(function(e,n){o.get(c.baseUrl+(t||"")).then(function(t){return e(t.data.d.results)}).catch(function(t){return n(t)})})},c.getOne=function(t,e){return new Promise(function(n,r){o.get("".concat(c.baseUrl,"(").concat(t,")").concat(e||"")).then(function(t){return n(t.data.d.results)}).catch(function(t){return r(t)})})},c.post=function(t){return new Promise(function(e,n){o.post(c.baseUrl,t).then(function(t){return e(t.data.d.results)}).catch(function(t){return n(t)})})},c.put=function(t,n){return o.post("".concat(c.baseUrl,"(").concat(t,")"),n,{headers:e({},o.defaults.headers.common,{"X-Http-Method":"MERGE","If-Match":"*"})})},c.put=function(t,e){return c.merge(t,e)},c.delete=function(t){return o.post("".concat(c.baseUrl,"(").concat(t,")"),{},{headers:e({},o.defaults.headers.common,{"X-Http-Method":"DELETE","If-Match":"*"})})}};

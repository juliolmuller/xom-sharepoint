...
function e(e,t,r,n,a,u,i){try{var c=e[u](i),s=c.value}catch(o){return void r(o)}c.done?t(s):Promise.resolve(s).then(n,a)}function t(t){return function(){var r=this,n=arguments;return new Promise(function(a,u){var i=t.apply(r,n);function c(t){e(i,a,u,c,s,"next",t)}function s(t){e(i,a,u,c,s,"throw",t)}c(void 0)})}}var r=require("../config/endpoint"),n=require("../utils/genFileBuffer"),a=require("../utils/genFileName"),u=require("../http/xomHttpFactory"),i=require("../utils/toPascalCase");module.exports=function(e,c){var s=this,o=e,p=null,f=c||u(),m=f.post(r.contextInfo(),{}).then(function(e){var t=e.data;return t.FormDigestValue||t.GetContextWebInformation.FormDigestValue});Object.defineProperty(this,"title",{get:function(){return o},set:function(e){o=e}}),Object.defineProperty(this,"name",{get:function(){return i(o)}}),Object.defineProperty(this,"lastHttpResponse",{get:function(){return p}}),this.get=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItems(s.name)+(t||""),e.next=3,f.get(n);case 3:return p=e.sent,e.abrupt("return",p.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.find=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n="".concat(r.listItems(s.name),"(").concat(t,")"),e.next=3,f.get(n);case 3:return p=e.sent,e.abrupt("return",p.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.create=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItems(s.name),e.next=3,f.post(n,t);case 3:return p=e.sent,e.abrupt("return",p.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.update=function(){var e=t(regeneratorRuntime.mark(function e(t,n){var a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return a="".concat(r.listItems(s.name),"(").concat(t,")"),e.next=3,f.put(a,n);case 3:return p=e.sent,e.abrupt("return",p.data);case 5:case"end":return e.stop()}},e)}));return function(t,r){return e.apply(this,arguments)}}(),this.delete=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n="".concat(r.listItems(s.name),"(").concat(t,")"),e.next=3,f.delete(n);case 3:return p=e.sent,e.abrupt("return",p.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.getAttachments=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItemsAttachment(s.title,t),e.next=3,f.get(n);case 3:return p=e.sent,e.abrupt("return",p.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.attach=function(){var e=t(regeneratorRuntime.mark(function e(t,u,i){var c,o,l;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return i=i||a(u),e.next=3,m;case 3:return c=e.sent,e.next=6,n(u);case 6:return o=e.sent,l="".concat(r.listItemsAttachment(s.title,t),"/add(filename='").concat(i,"')"),e.next=10,f.post(l,o,{requestDigest:c});case 10:return p=e.sent,e.abrupt("return",p.data);case 12:case"end":return e.stop()}},e)}));return function(t,r,n){return e.apply(this,arguments)}}(),this.rename=function(){var e=t(regeneratorRuntime.mark(function e(t,n,a){var u,i,c,o,l;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,m;case 2:return u=e.sent,e.next=5,s.getAttachments(t);case 5:return i=e.sent,c=i.filter(function(e){return e.FileName===n})[0],o=c.ServerRelativeUrl.replace(n,a),l="".concat(r.serverResource(c.ServerRelativeUrl),"/moveTo(newurl='").concat(o,"', flags=1)"),e.next=11,f.put(l,{},{requestDigest:u});case 11:return p=e.sent,e.abrupt("return",p.data);case 13:case"end":return e.stop()}},e)}));return function(t,r,n){return e.apply(this,arguments)}}(),this.remove=function(){var e=t(regeneratorRuntime.mark(function e(t,n){var a,u;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,m;case 2:return a=e.sent,u="".concat(r.listItemsAttachment(s.title,t),"/getByFileName('").concat(n,"')"),e.next=6,f.delete(u,{requestDigest:a});case 6:return p=e.sent,e.abrupt("return",p.data);case 8:case"end":return e.stop()}},e)}));return function(t,r){return e.apply(this,arguments)}}()};
...
function e(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function t(t){for(var n=1;n<arguments.length;n++){var a=null!=arguments[n]?arguments[n]:{};n%2?e(Object(a),!0).forEach(function(e){r(t,e,a[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(a)):e(Object(a)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(a,e))})}return t}function r(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function n(e,t,r,n,a,c,u){try{var o=e[c](u),i=o.value}catch(s){return void r(s)}o.done?t(i):Promise.resolve(i).then(n,a)}function a(e){return function(){var t=this,r=arguments;return new Promise(function(a,c){var u=e.apply(t,r);function o(e){n(u,a,c,o,i,"next",e)}function i(e){n(u,a,c,o,i,"throw",e)}o(void 0)})}}var c=require("../config/endpoint"),u=require("../http/xomHttpFactory"),o=require("./XomSharePointList"),i=require("./XomSharePointSurvey");module.exports=function(e){var r=this,n=null,s=u(e);Object.defineProperty(this,"baseUrl",{get:function(){return s.defaults.baseURL},set:function(e){s.defaults.baseURL=e}}),Object.defineProperty(this,"lastHttpResponse",{get:function(){return n}});var f=function(e){var t;return e.Id=e.Id||e.Id0,e.Account=e.LoginName||e.AccountName||e.Account,e.AccountName=(t=e.Account,String(t).replace(/(.*)[|](.*)/,"$2").replace(/\\/,"_")),e.UserId=e.AccountName.replace(/(.*)[_](.*)/,"$2"),e.Name=e.Name||e.DisplayName,e.PersonalUrl="https://mysite.na.xom.com/personal//".concat(e.AccountName),e.PictureUrl="http://lyncpictures/service/api/image/".concat(e.AccountName),e};this.getInfo=a(regeneratorRuntime.mark(function e(){var t;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t=c.siteInfo(),e.next=3,s.get(t);case 3:return n=e.sent,e.abrupt("return",n.data);case 5:case"end":return e.stop()}},e)})),this.getUserInfo=function(){var e=a(regeneratorRuntime.mark(function e(a){var u,o;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(a){e.next=2;break}return e.abrupt("return",r.getMyInfo());case 2:return e.next=4,s.get("".concat(c.userInfo(),"?$top=1"));case 4:return u=e.sent,o=u.data[0].Id?"Id":"Id0",e.next=8,Promise.all([s.get(c.user(a)),s.get("".concat(c.userInfo(),"?$filter=(").concat(o," eq ").concat(a,")"))]);case 8:return n=e.sent,e.abrupt("return",f(t({},n[0].data,{},n[1].data)));case 10:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.getMyInfo=a(regeneratorRuntime.mark(function e(){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,Promise.all([s.get(c.currentUser()),s.get(c.currentUserInfo())]);case 2:return n=e.sent,e.abrupt("return",f(t({},n[0].data,{},n[1].data)));case 4:case"end":return e.stop()}},e)})),this.searchUser=function(){var e=a(regeneratorRuntime.mark(function e(t){var r;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r="".concat(c.userInfo(),"?$filter=substringof('").concat(t,"',Name)"),e.next=3,s.get(r);case 3:return n=e.sent,e.abrupt("return",n.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.getResources=a(regeneratorRuntime.mark(function e(){var t;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t=c.resourcesIndex(),e.next=3,s.get(t);case 3:return n=e.sent,e.abrupt("return",n.data);case 5:case"end":return e.stop()}},e)})),this.getList=function(e){return new o(e,s)},this.getSurvey=function(e){return new i(e,s)}};
...
require("core-js/stable"),require("regenerator-runtime/runtime"),window.xomSharePoint=require("./sharepoint/index"),window.xomHttpFactory=require("./sharepoint/http/xomHttpFactory"),window.XomSharePointSite=require("./sharepoint/objects/XomSharePointSite"),window.XomSharePointList=require("./sharepoint/objects/XomSharePointList"),window.XomSharePointSurvey=require("./sharepoint/objects/XomSharePointSurvey");
},{"core-js/stable":"XqIO","regenerator-runtime/runtime":"QVnC","./sharepoint/index":"XVne","./sharepoint/http/xomHttpFactory":"EQhF","./sharepoint/objects/XomSharePointSite":"DCCh","./sharepoint/objects/XomSharePointList":"p0uT","./sharepoint/objects/XomSharePointSurvey":"tCvt"}]},{},["UeJd"], null)

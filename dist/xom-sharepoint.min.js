...
module.exports={siteInfo:function(){return"/_api/web"},contextInfo:function(){return"/_api/ContextInfo"},user:function(t){return"/_api/Web/GetUserById(".concat(t,")")},userInfo:function(){return"/_vti_bin/listdata.svc/UserInformationList"},currentUser:function(){return"/_api/web/CurrentUser"},currentUserInfo:function(){return"/_api/SP.UserProfiles.PeopleManager/GetMyProperties"},resourcesIndex:function(){return"/_api/lists"},list:function(t){return"/_api/web/lists/getByTitle('".concat(t,"')")},listFields:function(t){return"/_api/web/lists/getByTitle('".concat(t,"')/fields")},listItems:function(t){return"/_vti_bin/listdata.svc/".concat(t)},listItemsAttachment:function(t,e){return"/_api/web/lists/getByTitle('".concat(t,"')/items(").concat(e,")/AttachmentFiles")},serverResource:function(t){return"/_api/web/getFileByServerRelativeUrl('".concat(t,"')")}};
...
module.exports=function(e){var s=e.post;e.post=function(e,t,r){return(r=r||{}).headers=r.headers||this.defaults.headers.common,r.requestDigest&&(r.headers["X-RequestDigest"]=r.requestDigest),s(e,t,r)}};
},{}],"pukz":[function(require,module,exports) {
function e(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function t(t){for(var n=1;n<arguments.length;n++){var o=null!=arguments[n]?arguments[n]:{};n%2?e(Object(o),!0).forEach(function(e){r(t,e,o[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(o)):e(Object(o)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(o,e))})}return t}function r(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function n(e,t,r,n,o,c,a){try{var u=e[c](a),i=u.value}catch(s){return void r(s)}u.done?t(i):Promise.resolve(i).then(n,o)}function o(e){return function(){var t=this,r=arguments;return new Promise(function(o,c){var a=e.apply(t,r);function u(e){n(a,o,c,u,i,"next",e)}function i(e){n(a,o,c,u,i,"throw",e)}u(void 0)})}}module.exports=function(e){e.delete=function(){var e=o(regeneratorRuntime.mark(function e(r,n){var o,c;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if((n=n||{}).headers=n.headers||t({},this.defaults.headers.common,{"X-Http-Method":"DELETE","If-Match":"*"}),!n.requestDigest){e.next=6;break}e.t0={data:{Success:!0,Error:!1}},e.next=9;break;case 6:return e.next=8,this.get(r);case 8:e.t0=e.sent;case 9:return o=e.t0,e.next=12,this.post(r,{},n);case 12:return(c=e.sent).data=o.data,e.abrupt("return",c);case 15:case"end":return e.stop()}},e,this)}));return function(t,r){return e.apply(this,arguments)}}()};
},{}],"STcK":[function(require,module,exports) {
function e(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function t(t){for(var n=1;n<arguments.length;n++){var o=null!=arguments[n]?arguments[n]:{};n%2?e(Object(o),!0).forEach(function(e){r(t,e,o[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(o)):e(Object(o)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(o,e))})}return t}function r(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function n(e,t,r,n,o,c,u){try{var a=e[c](u),i=a.value}catch(s){return void r(s)}a.done?t(i):Promise.resolve(i).then(n,o)}function o(e){return function(){var t=this,r=arguments;return new Promise(function(o,c){var u=e.apply(t,r);function a(e){n(u,o,c,a,i,"next",e)}function i(e){n(u,o,c,a,i,"throw",e)}a(void 0)})}}module.exports=function(e){e.put=function(){var e=o(regeneratorRuntime.mark(function e(r,n,o){var c,u;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return(o=o||{}).headers=o.headers||t({},this.defaults.headers.common,{"X-Http-Method":o.requestDigest?"PUT ":"MERGE","If-Match":"*"}),e.next=4,this.post(r,n,o);case 4:if(c=e.sent,!o.requestDigest){e.next=9;break}e.t0={data:{Success:!0,Error:!1}},e.next=12;break;case 9:return e.next=11,this.get(r);case 11:e.t0=e.sent;case 12:return u=e.t0,c.data=u.data,e.abrupt("return",c);case 15:case"end":return e.stop()}},e,this)}));return function(t,r,n){return e.apply(this,arguments)}}()};
},{}],"DPVX":[function(require,module,exports) {
module.exports=function(e){e.defaults.withCredentials=!0,e.defaults.headers.common={Accept:"application/json;odata=verbose","Access-Control-Allow-Origin":"*","Access-Control-Allow-Headers":"Content-Type","Content-Type":"application/json;odata=verbose"}};
...
var e=require("@lacussoft/num-only"),t=/^\/Date\((\d+)\)\/$/,n=6e4;function r(t){return t=e(t),t=Number(t),t=(t=new Date(t)).getTime()+t.getTimezoneOffset()*n,new Date(t)}function o(e){Object.keys(e).forEach(function(n){t.test(e[n])&&(e[n]=r(e[n]))})}module.exports=function(e){if(e)try{e.constructor===Array?e.forEach(o):o(e)}catch(t){}return e};
},{"@lacussoft/num-only":"GX3L"}],"fWFn":[function(require,module,exports) {
module.exports=function(d){return d&&d.d?d.d.results||d.d:d};
},{}],"EQhF":[function(require,module,exports) {
function e(e){return o(e)||n(e)||t(e)||r()}function r(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function t(e,r){if(e){if("string"==typeof e)return s(e,r);var t=Object.prototype.toString.call(e).slice(8,-1);return"Object"===t&&e.constructor&&(t=e.constructor.name),"Map"===t||"Set"===t?Array.from(t):"Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?s(e,r):void 0}}function n(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function o(e){if(Array.isArray(e))return s(e)}function s(e,r){(null==r||r>e.length)&&(r=e.length);for(var t=0,n=new Array(r);t<r;t++)n[t]=e[t];return n}var a=require("axios").default,i=require("./requests/redefinePostRequest"),u=require("./requests/redefineDeleteRequest"),f=require("./requests/redefinePutRequest"),l=require("./requests/setDefaultHeaders"),c=require("./transform/convertResponseDates"),d=require("./transform/extractResponseData");module.exports=function(r){var t,n=a.create();return n.defaults.baseURL=r||(t=new RegExp(["/lists/","/folders/","/_layouts/","_api","/_vti_bin/"].join("|")),window.location.href.toLowerCase().split(t)[0]),l(n),i(n),u(n),f(n),n.defaults.transformResponse=[].concat(e(n.defaults.transformResponse),[d,c]),n};
...
function r(r,n){return i(r)||o(r,n)||e(r,n)||t()}function t(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function e(r,t){if(r){if("string"==typeof r)return n(r,t);var e=Object.prototype.toString.call(r).slice(8,-1);return"Object"===e&&r.constructor&&(e=r.constructor.name),"Map"===e||"Set"===e?Array.from(e):"Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?n(r,t):void 0}}function n(r,t){(null==t||t>r.length)&&(t=r.length);for(var e=0,n=new Array(t);e<t;e++)n[e]=r[e];return n}function o(r,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(r)){var e=[],n=!0,o=!1,i=void 0;try{for(var a,u=r[Symbol.iterator]();!(n=(a=u.next()).done)&&(e.push(a.value),!t||e.length!==t);n=!0);}catch(l){o=!0,i=l}finally{try{n||null==u.return||u.return()}finally{if(o)throw i}}return e}}function i(r){if(Array.isArray(r))return r}module.exports=function(t){var e=new FileReader,n=function(){switch(t.constructor.name){case"String":t=document.querySelector(t);case"HTMLInputElement":t=t.files;case"FileList":var e=r(t,1);t=e[0];case"File":return t;default:throw new TypeError("Type must be an instance of HTMLInputElement, FileList, File or String (input selector)")}}();return new Promise(function(r,t){e.onloadend=function(t){return r(t.target.result)},e.onerror=function(r){return t(r.target.error)},e.readAsArrayBuffer(n)})};
},{}],"DwEO":[function(require,module,exports) {
function t(t,n){return a(t)||o(t,n)||e(t,n)||r()}function r(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function e(t,r){if(t){if("string"==typeof t)return n(t,r);var e=Object.prototype.toString.call(t).slice(8,-1);return"Object"===e&&t.constructor&&(e=t.constructor.name),"Map"===e||"Set"===e?Array.from(e):"Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?n(t,r):void 0}}function n(t,r){(null==r||r>t.length)&&(r=t.length);for(var e=0,n=new Array(r);e<r;e++)n[e]=t[e];return n}function o(t,r){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(t)){var e=[],n=!0,o=!1,a=void 0;try{for(var i,u=t[Symbol.iterator]();!(n=(i=u.next()).done)&&(e.push(i.value),!r||e.length!==r);n=!0);}catch(l){o=!0,a=l}finally{try{n||null==u.return||u.return()}finally{if(o)throw a}}return e}}function a(t){if(Array.isArray(t))return t}module.exports=function(r){switch(r.constructor.name){case"String":r=document.querySelector(r);case"HTMLInputElement":r=r.files;case"FileList":r=t(r,1)[0];case"File":return r.name;default:return null}};
},{}],"O8QA":[function(require,module,exports) {
module.exports=function(e){return(e=(e=String(e)).replace(/([ ,.!?-])([A-Za-zÀ-ÿ]?)/g,function(e,r,t){return t.toUpperCase()})).charAt(0).toUpperCase()+e.slice(1)};
},{}],"p0uT":[function(require,module,exports) {
function e(e,t,r,n,a,u,i){try{var c=e[u](i),s=c.value}catch(o){return void r(o)}c.done?t(s):Promise.resolve(s).then(n,a)}function t(t){return function(){var r=this,n=arguments;return new Promise(function(a,u){var i=t.apply(r,n);function c(t){e(i,a,u,c,s,"next",t)}function s(t){e(i,a,u,c,s,"throw",t)}c(void 0)})}}var r=require("../config/endpoint"),n=require("../utils/genFileBuffer"),a=require("../utils/genFileName"),u=require("../http/xomHttpFactory"),i=require("../utils/toPascalCase");module.exports=function(e,c,s){var o=this,p=e,f=null,m=c||u(),l=s||m.post(r.contextInfo(),{}).then(function(e){var t=e.data;return t.FormDigestValue||t.GetContextWebInformation.FormDigestValue});Object.defineProperty(this,"title",{get:function(){return p},set:function(e){p=e}}),Object.defineProperty(this,"name",{get:function(){return i(p)}}),Object.defineProperty(this,"lastHttpResponse",{get:function(){return f}}),this.get=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItems(o.name)+(t||""),e.next=3,m.get(n);case 3:return f=e.sent,e.abrupt("return",f.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.find=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n="".concat(r.listItems(o.name),"(").concat(t,")"),e.next=3,m.get(n);case 3:return f=e.sent,e.abrupt("return",f.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.create=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItems(o.name),e.next=3,m.post(n,t);case 3:return f=e.sent,e.abrupt("return",f.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.update=function(){var e=t(regeneratorRuntime.mark(function e(t,n){var a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return a="".concat(r.listItems(o.name),"(").concat(t,")"),e.next=3,m.put(a,n);case 3:return f=e.sent,e.abrupt("return",f.data);case 5:case"end":return e.stop()}},e)}));return function(t,r){return e.apply(this,arguments)}}(),this.delete=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n="".concat(r.listItems(o.name),"(").concat(t,")"),e.next=3,m.delete(n);case 3:return f=e.sent,e.abrupt("return",f.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.getAttachments=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItemsAttachment(o.title,t),e.next=3,m.get(n);case 3:return f=e.sent,e.abrupt("return",f.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.attach=function(){var e=t(regeneratorRuntime.mark(function e(t,u,i){var c,s,p;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return i=i||a(u),e.next=3,l;case 3:return c=e.sent,e.next=6,n(u);case 6:return s=e.sent,p="".concat(r.listItemsAttachment(o.title,t),"/add(filename='").concat(i,"')"),e.next=10,m.post(p,s,{requestDigest:c});case 10:return f=e.sent,e.abrupt("return",f.data);case 12:case"end":return e.stop()}},e)}));return function(t,r,n){return e.apply(this,arguments)}}(),this.rename=function(){var e=t(regeneratorRuntime.mark(function e(t,n,a){var u,i,c,s,p;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,l;case 2:return u=e.sent,e.next=5,o.getAttachments(t);case 5:return i=e.sent,c=i.filter(function(e){return e.FileName===n})[0],s=c.ServerRelativeUrl.replace(n,a),p="".concat(r.serverResource(c.ServerRelativeUrl),"/moveTo(newurl='").concat(s,"', flags=1)"),e.next=11,m.put(p,{},{requestDigest:u});case 11:return f=e.sent,e.abrupt("return",f.data);case 13:case"end":return e.stop()}},e)}));return function(t,r,n){return e.apply(this,arguments)}}(),this.remove=function(){var e=t(regeneratorRuntime.mark(function e(t,n){var a,u;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,l;case 2:return a=e.sent,u="".concat(r.listItemsAttachment(o.title,t),"/getByFileName('").concat(n,"')"),e.next=6,m.delete(u,{requestDigest:a});case 6:return f=e.sent,e.abrupt("return",f.data);case 8:case"end":return e.stop()}},e)}));return function(t,r){return e.apply(this,arguments)}}()};
...
function e(e,t,r,n,a,u,i){try{var c=e[u](i),s=c.value}catch(o){return void r(o)}c.done?t(s):Promise.resolve(s).then(n,a)}function t(t){return function(){var r=this,n=arguments;return new Promise(function(a,u){var i=t.apply(r,n);function c(t){e(i,a,u,c,s,"next",t)}function s(t){e(i,a,u,c,s,"throw",t)}c(void 0)})}}var r=require("../config/endpoint"),n=require("../http/xomHttpFactory"),a=require("../utils/toPascalCase");module.exports=function(e,u){var i=this,c=e,s=null,o=u||n();Object.defineProperty(this,"title",{get:function(){return c},set:function(e){c=e}}),Object.defineProperty(this,"name",{get:function(){return a(c)}}),Object.defineProperty(this,"lastHttpResponse",{get:function(){return s}}),this.getQuestions=t(regeneratorRuntime.mark(function e(){var t;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t="".concat(r.listFields(i.title),"?$filter=(CanBeDeleted eq true)"),e.next=3,o.get(t);case 3:return s=e.sent,e.abrupt("return",s.data.map(function(e){return{Field:"".concat(a(e.Title),"Value"),Question:e.Title,Type:e.TypeDisplayName,Choices:e.Choices&&e.Choices.results}}));case 5:case"end":return e.stop()}},e)})),this.get=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItems(i.name)+(t||""),e.next=3,o.get(n);case 3:return s=e.sent,e.abrupt("return",s.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.find=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n="".concat(r.listItems(i.name),"(").concat(t,")"),e.next=3,o.get(n);case 3:return s=e.sent,e.abrupt("return",s.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.findByUser=function(e){return i.get("?$filter=(CreatedById eq ".concat(e,")"))},this.create=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.listItems(i.name),e.next=3,o.post(n,t);case 3:return s=e.sent,e.abrupt("return",s.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.update=function(){var e=t(regeneratorRuntime.mark(function e(t,n){var a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return a="".concat(r.listItems(i.name),"(").concat(t,")"),e.next=3,o.put(a,n);case 3:return s=e.sent,e.abrupt("return",s.data);case 5:case"end":return e.stop()}},e)}));return function(t,r){return e.apply(this,arguments)}}(),this.delete=function(){var e=t(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n="".concat(r.listItems(i.name),"(").concat(t,")"),e.next=3,o.delete(n);case 3:return s=e.sent,e.abrupt("return",s.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}()};
},{"../config/endpoint":"CFNo","../http/xomHttpFactory":"EQhF","../utils/toPascalCase":"O8QA"}],"DCCh":[function(require,module,exports) {
function e(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function t(t){for(var n=1;n<arguments.length;n++){var a=null!=arguments[n]?arguments[n]:{};n%2?e(Object(a),!0).forEach(function(e){r(t,e,a[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(a)):e(Object(a)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(a,e))})}return t}function r(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function n(e,t,r,n,a,u,o){try{var c=e[u](o),s=c.value}catch(i){return void r(i)}c.done?t(s):Promise.resolve(s).then(n,a)}function a(e){return function(){var t=this,r=arguments;return new Promise(function(a,u){var o=e.apply(t,r);function c(e){n(o,a,u,c,s,"next",e)}function s(e){n(o,a,u,c,s,"throw",e)}c(void 0)})}}var u=require("../config/endpoint"),o=require("../http/xomHttpFactory"),c=require("./XomSharePointList"),s=require("./XomSharePointSurvey");module.exports=function(e){var r=this,n=null,i=o(e),f=i.post(u.contextInfo(),{}).then(function(e){var t=e.data;return t.FormDigestValue||t.GetContextWebInformation.FormDigestValue});Object.defineProperty(this,"baseUrl",{get:function(){return i.defaults.baseURL},set:function(e){i.defaults.baseURL=e}}),Object.defineProperty(this,"lastHttpResponse",{get:function(){return n}});var p=function(e){var t;return e.Id=e.Id||e.Id0,e.Account=e.LoginName||e.AccountName||e.Account,e.AccountName=(t=e.Account,String(t).replace(/(.*)[|](.*)/,"$2").replace(/\\/,"_")),e.UserId=e.AccountName.replace(/(.*)[_](.*)/,"$2"),e.Name=e.Name||e.DisplayName,e.PersonalUrl="https://mysite.na.xom.com/personal//".concat(e.AccountName),e.PictureUrl="http://lyncpictures/service/api/image/".concat(e.AccountName),e};this.getInfo=a(regeneratorRuntime.mark(function e(){var t;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t=u.siteInfo(),e.next=3,i.get(t);case 3:return n=e.sent,e.abrupt("return",n.data);case 5:case"end":return e.stop()}},e)})),this.getUserInfo=function(){var e=a(regeneratorRuntime.mark(function e(a){var o,c;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(a){e.next=2;break}return e.abrupt("return",r.getMyInfo());case 2:return e.next=4,i.get("".concat(u.userInfo(),"?$top=1"));case 4:return o=e.sent,c=o.data[0].Id?"Id":"Id0",e.next=8,Promise.all([i.get(u.user(a)),i.get("".concat(u.userInfo(),"?$filter=(").concat(c," eq ").concat(a,")"))]);case 8:return n=e.sent,e.abrupt("return",p(t({},n[0].data,{},n[1].data[0])));case 10:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.getMyInfo=a(regeneratorRuntime.mark(function e(){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,Promise.all([i.get(u.currentUser()),i.get(u.currentUserInfo())]);case 2:return n=e.sent,e.abrupt("return",p(t({},n[0].data,{},n[1].data)));case 4:case"end":return e.stop()}},e)})),this.searchUser=function(){var e=a(regeneratorRuntime.mark(function e(t){var r;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r="".concat(u.userInfo(),"?$filter=substringof('").concat(t,"',Name)"),e.next=3,i.get(r);case 3:return n=e.sent,e.abrupt("return",n.data);case 5:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.getResources=a(regeneratorRuntime.mark(function e(){var t;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t=u.resourcesIndex(),e.next=3,i.get(t);case 3:return n=e.sent,e.abrupt("return",n.data);case 5:case"end":return e.stop()}},e)})),this.getList=function(e){return new c(e,i,f)},this.createList=function(){var e=a(regeneratorRuntime.mark(function e(t,r){var a,o;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,f;case 2:return a=e.sent,o=u.resourcesIndex(),e.next=6,i.post(o,{__metadata:{type:"SP.List"},BaseTemplate:r||100,Title:t},{requestDigest:a});case 6:return n=e.sent,e.abrupt("return",n.data);case 8:case"end":return e.stop()}},e)}));return function(t,r){return e.apply(this,arguments)}}(),this.deleteList=function(){var e=a(regeneratorRuntime.mark(function e(t){var r,a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,f;case 2:return r=e.sent,a=u.list(t),e.next=6,i.delete(a,{requestDigest:r});case 6:return n=e.sent,e.abrupt("return",n.data);case 8:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.getSurvey=function(e){return new s(e,i)}};
...
require("core-js/stable"),require("regenerator-runtime/runtime");var e=require("./objects/XomSharePointSite");module.exports=function(r){return new e(r)};
},{"core-js/stable":"XqIO","regenerator-runtime/runtime":"QVnC","./objects/XomSharePointSite":"DCCh"}],"UeJd":[function(require,module,exports) {
window.xomSharePoint=require("./sharepoint/index"),window.xomHttpFactory=require("./sharepoint/http/xomHttpFactory"),window.XomSharePointSite=require("./sharepoint/objects/XomSharePointSite"),window.XomSharePointList=require("./sharepoint/objects/XomSharePointList"),window.XomSharePointSurvey=require("./sharepoint/objects/XomSharePointSurvey");

 ...
 * @return {String}
 */
endpoints.users.listFields = (query) => `${endpoints.users.listMetadata()}/Fields${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.users.listItems = (query) => `${endpoints.users.listMetadata()}/Items${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.lists.index = (query) => `${endpoints.baseApiUri()}/Lists${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.lists.byTitle = (listTitle, query) => `${endpoints.lists.index()}/GetByTitle('${listTitle}')${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.lists.fields = (listTitle, query) => `${endpoints.lists.byTitle(listTitle)}/Fields${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.lists.items = (listTitle, query) => `${endpoints.lists.byTitle(listTitle)}/Items${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.lists.itemById = (listTitle, itemId, query) => endpoints.lists.items(listTitle, `(${itemId})${stringify(query)}`)
 ...
 * @return {String}
 */
endpoints.folders.index = (query) => `${endpoints.baseApiUri()}/Folders${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.folders.foldersInFolder = (relativeUrl, query) => `${endpoints.folders.folderByUrl(relativeUrl)}/Folders${stringify(query)}`
 ...
 * @return {String}
 */
endpoints.folders.filesInFolder = (relativeUrl, query) => `${endpoints.folders.folderByUrl(relativeUrl)}/Files${stringify(query)}`
